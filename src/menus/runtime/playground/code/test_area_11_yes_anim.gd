...
func anim_loop_1() -> void:
	...
	PlayerInput.flipper_A_touched.emit(true)
	PlayerInput.flipper_B_touched.emit(true)
...
func anim_loop_2() -> void:
	...
	PlayerInput.flipper_A_touched.emit(false)
	PlayerInput.flipper_B_touched.emit(false)
